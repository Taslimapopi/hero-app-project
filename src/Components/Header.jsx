    ...
    <div>
      <div className="flex flex-col justify-center items-center p-3 space-y-4 m-4">
        ...
        <div className="space-x-2">
            <button className="btn inline "><a href="" className="flex items-center gap-2"><img className="h-6 w-6" src={googleplay} alt="" /> Google Play</a></button>
            <button className="btn"><a href="" className="flex items-center gap-2"><img src={appStoreimg} alt="" />App Stoor</a></button>            
        </div>
      </div>
      <div>
